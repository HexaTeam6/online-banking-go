...
// Source: internal/security/hasher.go
//
// Generated by this command:
//
//	mockgen -source=internal/security/hasher.go -destination=test/mock/mock_password_hasher.go -package=mock
//
...
func (mr *MockPasswordHasherMockRecorder) Compare(hashedPassword, plainPassword any) *gomock.Call {
